...
public class PoliceActivity extends AppCompatActivity
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        String queryUrl="http://openapi.jeonju.go.kr/rest/patroldiv/getPatrolDivList?authApiKey=8rULtNWhTcB9%2FM2fsJHpyZqt%2FK94LqQWfNl9QTmvLKP56PotRCl8iO2yOaYnxffLg7nG8qHsMPLIijmqenTyrg%3D%3D";//요청 URL
            ...
            while (parserEvent != XmlPullParser.END_DOCUMENT){
                ...
                switch(parserEvent){
                    case XmlPullParser.START_TAG://parser가 시작 태그를 만나면 실행
                        ...
                        else if(parser.getName().contains("patrolTitle")){
                            inName = true;
                        }
                        else if(parser.getName().contains("patrolTel")){ //mapx 만나면 내용을 받을수 있게 하자
                            inPhone= true;
                        }
